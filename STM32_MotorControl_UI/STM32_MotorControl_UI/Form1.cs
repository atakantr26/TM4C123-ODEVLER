...
namespace STM32_MotorControl_UI
{
    public partial class Form1 : Form
    {
        ...
        private void ProcessReceivedLine(string line)
        {
            ...
            lblLastPacket.Text = "Son Veri: " + DateTime.Now.ToString("HH:mm:ss");
        }
        ...
        private void btnFakeData_Click(object? sender, EventArgs e)
        {
            ...
            ProcessReceivedLine(selectedLine);
        ...
        private void SendCommandToStm32(string command)
        {
            ...
            try
            {
                if (!serialPort.IsOpen)
                {
                    ...
                    MessageBox.Show("Önce STM32 bağlantısını açmalısın.");
                    return;
                }

                serialPort.WriteLine(command);

                lblCommandStatus.Text = "Son Komut: " + command;
